  ...
  return (
    <div className="bg-white">
      ...
      <div className="h-max bg-white mt-12 mb-12 ">
        <div className="max-w-7xl mx-auto flex border lg:border-gray-800 ">
          {/* Left Side - Benefits */}
            ...
            <div className="max-w-md">
              ...
              <div className="mt-12 grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-300">Local Businesses</div>
                </div>
                <div>
                  ...
                  >
                    {isLoading
                      ? registrationMethod === "phone" && !otpSent
                        ...
                        ? "Verifying..."
                        : "Creating account..."
                      : registrationMethod === "phone" && phoneStep === "phone"
                      ? "Send OTP"
                      : registrationMethod === "phone" && phoneStep === "otp"
                      ? "Verify OTP"
                      : "Create account"}
